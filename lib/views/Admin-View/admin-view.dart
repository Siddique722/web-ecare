  ...
  Future<Map<String, dynamic>> _fetchUserProfileData(String userId) async {
    try {
      ...
      if (userProfileSnapshot.exists) {
        ...
        String imageUrl = 'https://firebasestorage.googleapis.com/v0/b/e-health1-psa71c.appspot.com/o/user1.png?alt=media&token=b59c8843-d19c-4705-868d-579e6541abd1'; // Default URL if no image found
        if (usersDataSnapshot.docs.isNotEmpty) {
          userEmail =
              usersDataSnapshot.docs.first.data()['userEmail'] ?? 'No Email';
          imageUrl = usersDataSnapshot.docs.first.data()['profileImage'] ??
              'https://firebasestorage.googleapis.com/v0/b/e-health1-psa71c.appspot.com/o/user1.png?alt=media&token=b59c8843-d19c-4705-868d-579e6541abd1'; // Get image URL
        }
        ...
        return {
          ...
          'userEmail': 'No Email',
          'imageUrl': 'https://firebasestorage.googleapis.com/v0/b/e-health1-psa71c.appspot.com/o/user1.png?alt=media&token=b59c8843-d19c-4705-868d-579e6541abd1', // Default URL
        };
      }
    } catch (e) {
      return {
        ...
        'imageUrl': 'https://firebasestorage.googleapis.com/v0/b/e-health1-psa71c.appspot.com/o/user1.png?alt=media&token=b59c8843-d19c-4705-868d-579e6541abd1', // Default URL in case of error
      };
    }
  }
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'e.g., ${_cartDataList.length}',
              ),
            ),
          ],
        ),
          ...
          TextButton(
            onPressed: () {
              ...
              if (start <= 0 || end > _cartDataList.length || start > end) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Invalid range! Please enter a valid range.'),
                  ),
                );
              } else {
                Navigator.pop(context); // Close the dialog
                _createAndSavePDF(start - 1, end); // Pass adjusted indices
              }
            },
...
//               //                   ),
//               //                 ),
//               //               );yle: TextStyle(color: Colors.grey[600]),
//               //           ),
//               //           SizedBox(height: 4.0),
//               //           Text(
//               //             'Address: ${cartItem['address']}',
