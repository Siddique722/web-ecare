...
import 'package:ecare/views/Create-Profile-Views/alergic0medications/alergic-medications.dart';

import 'package:flutter/cupertino.dart';
import 'package:get/get.dart';

class AlergicMedications extends StatelessWidget {
  final String? role;
  final String? userId;
  final Map<String, dynamic>? userProfileData;
  final Map<String, dynamic>? comorbiditiesData;
  ...
  final AllergicMedicationsController controller =
      Get.put(AllergicMedicationsController());
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            onPressed: () {
              controller.storeUserData(userId);
              print('object=${controller.allergicMedicationsData}');
              Navigator.push(
                context,
                CupertinoPageRoute(
                  builder: (context) => CurrentOngoingMedications(
                    ...
                    allergicMedicationsData: controller.allergicMedicationsData,
                  ),
                ),
              );
            },
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              LightDarktextField(
                controller: controller.medicineController1,
                hintText: 'Name of the medicine',
                keyboardType: TextInputType.text,
              ),
              LightDarktextField(
                controller: controller.medicineController2,
                hintText: 'Name of the medicine',
                keyboardType: TextInputType.text,
              ),
              LightDarktextField(
                controller: controller.medicineController3,
                hintText: 'Name of the medicine',
                keyboardType: TextInputType.text,
              ),
              LightDarktextField(
                controller: controller.medicineController4,
                hintText: 'Name of the medicine',
                keyboardType: TextInputType.text,
              ),
              LightDarktextField(
                controller: controller.medicineController5,
                hintText: 'Name of the medicine',
                keyboardType: TextInputType.text,
              ),
              InkWell(
                    ...
                    CupertinoPageRoute(
                      builder: (context) => CurrentOngoingMedications(
                        ...
                        allergicMedicationsData:
                            controller.allergicMedicationsData,
                      ),
                    ),
                  );
                },
