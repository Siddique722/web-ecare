...
import 'package:ecare/views/Create-Profile-Views/combrobities/combrobities-controller.dart';
...
class ComorbitiesView extends StatelessWidget {
  final String? role;
  final String? userID;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            onPressed: controller.storeUserData,
            child: Text(
              'Skip',
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Obx(() => LighDarkDropDown(
                    hint: 'Please select',
                    items: controller.availableComorbidities1,
                    value: controller.selectedComorbidity1.value,
                    onChanged: (value) {
                      controller.selectedComorbidity1.value =
                          value == 'Unselect' ? null : value;
                      controller.updateAvailableComorbidities();
                    },
                  )),
              Obx(() => LighDarkDropDown(
                    hint: 'Please select',
                    items: controller.availableComorbidities2,
                    value: controller.selectedComorbidity2.value,
                    onChanged: (value) {
                      controller.selectedComorbidity2.value =
                          value == 'Unselect' ? null : value;
                      controller.updateAvailableComorbidities();
                    },
                  )),
              Obx(() => LighDarkDropDown(
                    hint: 'Please select',
                    items: controller.availableComorbidities3,
                    value: controller.selectedComorbidity3.value,
                    onChanged: (value) {
                      controller.selectedComorbidity3.value =
                          value == 'Unselect' ? null : value;
                      controller.updateAvailableComorbidities();
                    },
                  )),
              Obx(() => LighDarkDropDown(
                    hint: 'Please select',
                    items: controller.availableComorbidities4,
                    value: controller.selectedComorbidity4.value,
                    onChanged: (value) {
                      controller.selectedComorbidity4.value =
                          value == 'Unselect' ? null : value;
                      controller.updateAvailableComorbidities();
                    },
                  )),
              Obx(() => LighDarkDropDown(
                    hint: 'Please select',
                    items: controller.availableComorbidities5,
                    value: controller.selectedComorbidity5.value,
                    onChanged: (value) {
                      controller.selectedComorbidity5.value =
                          value == 'Unselect' ? null : value;
                      controller.updateAvailableComorbidities();
                    },
                  )),
              Obx(() => LighDarkDropDown(
                    hint: 'Please select',
                    items: controller.availableComorbidities6,
                    value: controller.selectedComorbidity6.value,
                    onChanged: (value) {
                      controller.selectedComorbidity6.value =
                          value == 'Unselect' ? null : value;
                      controller.updateAvailableComorbidities();
                    },
                  )),
              InkWell(
                onTap: controller.storeUserData,
                child: BlueButton(
                  text: 'Next',
                ),
              ),
