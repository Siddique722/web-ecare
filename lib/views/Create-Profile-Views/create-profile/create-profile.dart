...
import 'package:ecare/views/Create-Profile-Views/create-profile/create-profile-controller.dart';
...
class CreateProfileScreen extends StatelessWidget {
  ...
  CreateProfileScreen({super.key, this.role});
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                LightDarktextField(
                  controller: controller.emergencyContact1Controller,
                  hintText: 'Emergency Contact Number 1',
                  keyboardType: TextInputType.phone,
                ),
                Obx(() => LighDarkDropDown(
                      ...
                      value: controller.emergencyContact1Relation.value,
                      onChanged: (value) =>
                          controller.emergencyContact1Relation.value = value,
                    )),
                LightDarktextField(
                  controller: controller.emergencyContact2Controller,
                  hintText: 'Emergency Contact Number 2',
                  keyboardType: TextInputType.phone,
                ),
                Obx(() => LighDarkDropDown(
                      ...
                      value: controller.emergencyContact2Relation.value,
                      onChanged: (value) =>
                          controller.emergencyContact2Relation.value = value,
                    )),
                Obx(() => LighDarkDropDown(
                      hint: 'Blood Group',
                ...
                LightDarkDateField(
                  ...
                  onTap: (context) {
                    return controller
                        .selectDate(context); // Pass the context explicitly
                  },
                ),
                SizedBox(height: 20.0),
                InkWell(
                  onTap: () => controller.storeUserData(role),
                  child: BlueButton(text: 'Next'),
                ),
              ],
            ),
