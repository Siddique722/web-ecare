...
class ApiService {
  ...
  Future<void> handlePaymentSuccess(PaymentSuccessResponse response, TextEditingController addressController,
      TextEditingController pinCodeController, List<Map<String, dynamic>> cartItems) async {
    final userId = FirebaseAuth.instance.currentUser!.uid;
  ...
  void handlePaymentError(PaymentFailureResponse response, BuildContext context) {
