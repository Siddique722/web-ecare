...
// import 'package:demo_app/views/Home-Views/ambulance-view/create-new-ambulance/update-ambulance.dart';
...
//   // List to store fetched ambulances from Firestore
...
//                               ),
//                             ));
//                         // You can also use Navigator.pushNamed() to navigate to a named route.
//                         // Navigator.pushNamed(context, '/ambulance_details', arguments: ambulance);
//                         // You can also use Navigator.pushReplacement() to replace the current route with a new one.
//                         // Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => AmbulanceDetailsPage(ambulance: ambulance)));
//                         // You can also use Navigator.pushAndRemoveUntil() to replace the current route with a new one and remove all routes before it.
//                         // Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => AmbulanceDetailsPage(ambulance: ambulance)), (route) => false);
//                       },
//                       title: Text(
