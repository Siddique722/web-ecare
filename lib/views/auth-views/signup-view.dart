...
class _SignupViewState extends State<SignupView> {
 ...
 // bool _termsAccepted = false; // State variable for terms acceptance
                          ...
                          onTap: () {
                            if (_termsAccepted) {
                              ...
                              if (_passwordController.text != _confirmPasswordController.text) {
                                ...
                                _signUp(); // Call your signup function here
                              }
                            } else {
                              // Show error if terms and conditions are not accepted
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
